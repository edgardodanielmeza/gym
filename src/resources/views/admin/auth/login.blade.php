...
<head>
    ...
    <!-- Asumiendo que Tailwind CSS está configurado globalmente -->
        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="mb-4">
                ...
                <input id="nombre_usuario" type="text" name="nombre_usuario" value="{{ old('nombre_usuario') }}" required autofocus
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('nombre_usuario') border-red-500 @enderror">
